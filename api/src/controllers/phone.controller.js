 ...
 */
 ...
 exports.findPhoneByNumber = async(req, res) => {
    ...
    const response = await db.query('SELECT * FROM phone WHERE phonenumber = $1',
    [phone_Number]);
 ...
 exports.deletePhoneByNumber = async (req, res) => {
    ...
    await db.query('DELETE FROM phone WHERE phonenumber = $1', [
      phone_number
    ]);

    res.status(200).send({ message: 'Phone deleted successfully!', PhoneByNumber })
 };